export let data = {
  ...
  works: {
    select: {
      ...
      dsc: 'The dynamically created animated drop-down list. It uses JavaScript and CSS and can be used anywhere in HTML document as a separate element',
      name: 'Select plugin'
    },
    index: {
    ...
    butterfly: {
      ...
      dsc: 'An example of beautiful animation in pure CSS can be used in website design',
